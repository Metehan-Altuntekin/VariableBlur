...
public struct VariableBlurView: UIViewRepresentable {
    ...
    public var endOffset: CGFloat = 1
    
    public init(maxBlurRadius: CGFloat = 20, direction: VariableBlurDirection = .blurredTopClearBottom, startOffset: CGFloat = 0, endOffset: CGFloat = 1) {
        self.maxBlurRadius = maxBlurRadius
        self.direction = direction
        self.startOffset = startOffset
        self.endOffset = endOffset  // 1.0 = full height of view, 0.5 = half, etc.
    }
...
open class VariableBlurUIView: UIVisualEffectView {
    ...
    public init(maxBlurRadius: CGFloat = 20, direction: VariableBlurDirection = .blurredTopClearBottom, startOffset: CGFloat = 0, endOffset: CGFloat = 1) {
        ...
        let gradientImage = makeGradientImage(startOffset: startOffset, endOffset: endOffset, direction: direction)
    ...
    private func makeGradientImage(width: CGFloat = 100, height: CGFloat = 100, startOffset: CGFloat, endOffset: CGFloat, direction: VariableBlurDirection) -> CGImage { // much lower resolution might be acceptable
...
//        let ciGradientFilter =  CIFilter.smoothLinearGradient()
        ...
        ciGradientFilter.point1 = CGPoint(x: 0, y: height * (1 - endOffset)) // fades to zero over endOffset * height
